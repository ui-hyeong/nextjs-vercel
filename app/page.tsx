...
export default function Home() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      content: '기본적��� 2열 구조 레이아웃입니다. 모바일에서는 세로로, 데스크톱에서는 가로로 배치됩니다.',
    },
    {
      ...
      <div className="flex flex-grow">
        ...
        <main className="flex-grow flex justify-center p-8">
          <div className="w-full lg:w-1/2 overflow-y-auto p-8 border-r border-gray-200">
            <h1 className="text-4xl font-bold mb-8 text-gray-900">레이아웃 스터디</h1>
  ...
  <div className="bg-purple-100 p-4 rounded">Column 3</div>
              ...
              <section className="sidebar-layout">
                ...
                <p className="mb-4">이 레이아웃은 사이드바와 메인 콘텐츠 영역을 가진 일반적인 웹 페이지 구조를 보여줍���다.</p>
                <button
